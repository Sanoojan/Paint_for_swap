...
# Set variables
Results_out="/home/sanoojan/e4s/Results/testbench/results_CelebA_ckpt_without_crop/results"
Write_results="results/quantitative/e4s/results_CelebA_ckpt_without_crop"
