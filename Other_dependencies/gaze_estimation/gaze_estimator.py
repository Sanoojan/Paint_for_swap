...
from Other_dependencies.gaze_estimation.models.eyenet import EyeNet
...
class Gaze_estimator(nn.Module):
    def __init__(self):
        ...
        self.checkpoint = torch.load('Other_dependencies/Gaze_est_model/GazeEstimator.pt', map_location=self.device)
